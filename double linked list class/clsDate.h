...
public:
	...
	static string	GetSystemDateTimeString()
	{
		...
		string TimeNow = to_string(now->tm_hour) + ":" + to_string(now->tm_min) + ":" + to_string(now->tm_sec);
		return DateToString(clsDate())+" - " + TimeNow;
...
//	clsDate(short DateOrderInYear,short Year)
//	{
//		*this=this->GetDateFromDayOrderInYear(DateOrderInYear, Year);
//	}
//	void Print()
//	{
//		printf("%d/%d/%d\n", _Day, _Month, _Year);
